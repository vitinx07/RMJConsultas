              ...
              <nav className="hidden lg:flex items-center gap-1">
                ...
                <Link href="/historico">
                  <Button
                    variant="ghost"
                    size="sm"
                    className={getNavButtonClass("/historico")}
                  >
                ...
                <Link href="/favoritos">
                  <Button
                    variant="ghost"
                    size="sm"
                    className={getNavButtonClass("/favoritos")}
                  >
                ...
                <Link href="/notificacoes">
                  <Button
                    variant="ghost"
                    size="sm"
                    className={getNavButtonClass("/notificacoes")}
                  >
              ...
              <nav className="flex flex-col space-y-2">
                <Link href="/" onClick={() => setIsMobileMenuOpen(false)}>
                  <Button
                    variant="ghost"
                    size="sm"
                    className={`w-full justify-start ${getNavButtonClass("/")}`}
                  >
                ...
                >
                  <Button
                    variant="ghost"
                    size="sm"
                    className={`w-full justify-start ${getNavButtonClass("/dashboard")}`}
                  >
                ...
                >
                  <Button
                    variant="ghost"
                    size="sm"
                    className={`w-full justify-start ${getNavButtonClass("/historico")}`}
                  >
                ...
                >
                  <Button
                    variant="ghost"
                    size="sm"
                    className={`w-full justify-start ${getNavButtonClass("/favoritos")}`}
                  >
                ...
                >
                  <Button
                    variant="ghost"
                    size="sm"
                    className={`w-full justify-start ${getNavButtonClass("/notificacoes")}`}
                  >
                ...
                {user.role === "administrator" && (
                  ...
                  >
                    <Button
                      variant="ghost"
                      size="sm"
                      className={`w-full justify-start ${getNavButtonClass("/usuarios")}`}
                    >
