...
- July 30, 2025. Enhanced Banco Safra simulation with customizable options: Added user-selectable prazo (term) options (84, 96, 108, 120 months), implemented optional parcela (installment value) input for value-based simulations, added toggle between prazo and parcela simulation modes, maintained multi-contract selection capability, standardized all simulation buttons to blue color scheme for consistency across all banks